                            ...
                            <div class="card-body">
                                ...
                                <table class="table">
                                    <tr>
                                        <th>Id sản phẩm</th>
                                        <th>Tên sản phẩm</th>
                                        <th>Image sản phẩm</th>
                                        <th>Xử lý</th>
                                    </tr>
                                    <?php
                                    include_once "../class/user_class.php";
                                    $user = new users_class();
                                    $show_comment = $user->show_comment();
                                    if (isset($show_comment)) {
                                        while ($row = $show_comment->fetch_assoc()) {
                                    ?>
                                            <tr>
                                                <td width="200px"><?php echo $row['id_sanpham']; ?></td>
                                                <td width="300px"><?php echo $row['ten_sanpham']; ?></td>
                                                <td width="300px">
                                                    <img class="img_data" src="upload/<?php echo $row['img_sanpham']; ?>">
                                                </td>
                                                <td>
                                                    <a style="text-decoration: none; color: white;" href="./chi_tiet_comment.php?id_chitiet=<?php echo $row['id_sanpham']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw">Chi tiết</button></a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
