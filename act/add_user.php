            ...
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                        <h4 style="margin: 25px 0 ;" class="card-title">Thông tin use thêm mới</h4>
                        <form method="post" enctype="multipart/form-data">
                            <div>
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" placeholder="Name" name="ten_khachhang" required>
                                </div>
                                <div class="form-group">
                                    <label>Email address</label>
                                    <input type="email" class="form-control" placeholder="Email" name="email_khachhang" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Phone number" name="sdt_khachhang" required>
                                </div>
                                <div class="form-group">
