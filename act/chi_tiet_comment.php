            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="margin:25px 0">Comment</h4>
                                <table class="table">
                                    <tr>
                                        <th>Id comment</th>
                                        <th>Tên khách hàng</th>
                                        <th>Image khách hàng</th>
                                        <th>SĐT</th>
                                        <th>Địa chỉ</th>
                                        <th>Nội dung</th>
                                        <th>Ngày viết</th>
                                    ...
                                    $product = new users_class();
                                    if (isset($_GET['id_del'])) {
                                        $del_user = $user->del_comment($_GET['id_del']);
                                    }
                                    $show_comment = $product->show_comment_chi_tiet($_GET['id_chitiet']);
                                    if (isset($show_comment)) {
                                        while ($row = $show_comment->fetch_assoc()) {
                                    ?>
                                            <tr>
                                                <td width="200px"><?php echo $row['id_binhluan']; ?></td>
                                                <td width="300px"><?php echo $row['ten_khachhang']; ?></td>
                                                <td width="300px">
                                                    <img class="img_data" src="upload/<?php echo $row['img_khachhang']; ?>">
                                                </td>
                                                <td width="300px"><?php echo $row['sdt_khachhang']; ?></td>
                                                <td width="300px"><?php echo $row['dia_chi']; ?></td>
                                                <td width="300px"><?php echo $row['noi_dung']; ?></td>
                                                <td width="300px"><?php echo $row['ngay_binhluan']; ?></td>
                                                <td>
                                                    <a style="text-decoration: none; color: white;" onclick="return confirm('Bạn có muốn xóa comment này không ?')" href="?id_del=<?php echo $row['id_binhluan']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw">Xóa</button></a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
