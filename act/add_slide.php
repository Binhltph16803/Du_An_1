            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <?php
                            if (isset($_POST['ten_slide']) && isset($_POST['ulr'])) {
                                $add_slide = $product->add_slide($_POST['ten_slide'], $_FILES['image']['name'], $_POST['ulr']);
                            ...
                            ?>
                            <div class="card-body">
                                <h4 class="card-title" style="margin:25px 0">Thêm slide</h4>
                                <form method="post" enctype="multipart/form-data">
                                    <div>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" class="form-control" placeholder="Name" name="ten_slide" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Ulr</label>
                                            <input type="text" class="form-control" placeholder="Ulr slide" name="ulr" required>
                                        </div>
                                    </div>
