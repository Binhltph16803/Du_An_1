            ...
            <div class="main-panel">
                <div class="content-wrapper">
                        ...
                        <div class="card">
                            ...
                            <table class="table table-striped">
                                ...
                                if (isset($_GET['id_del'])) {
                                    $del_sp = $product->del_sanpham($_GET['id_del']);
                                }
                                $show_products = $product->show_sanpham();
                                if (isset($show_products)) {
                                    while ($row = $show_products->fetch_assoc()) {
                                ?>
                                        <tr>
                                            <td><?php echo $row['id_sanpham']; ?></td>
                                            <td><?php echo $row['id_loaihang']; ?></td>
                                            <td><?php echo $row['ten_sanpham']; ?></td>
                                            <td><img src="upload/<?php echo $row['img_sanpham']; ?>" alt=""></td>
                                            <td><?php echo $row['gia']; ?></td>
                                            <td><?php echo $row['giam_gia']; ?></td>
                                            <td><?php echo $row['kich_co']; ?></td>
                                            <td><?php echo $row['so_luong']; ?></td>
                                            <td style="max-width: 200px; overflow:auto"><?php echo $row['mo_ta']; ?></td>
                                            <td><?php echo $row['luot_xem']; ?></td>
                                            <td><?php echo $row['ngay_nhap']; ?></td>
                                            <td>
                                                <a style="text-decoration: none; color: white;" href="./edit_product.php?id_edit=<?php echo $row['id_sanpham']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw" style="margin-bottom:20px;">Sửa</button></a>
                                                <br>
                                                <a style="text-decoration: none; color: white;" onclick="return confirm('Bạn có muốn xóa Sp này không ?')" href="?id_del=<?php echo $row['id_sanpham']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw">Xóa</button></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
                    ...
                    <div class="template-demo">
                        <a style="text-decoration: none; color: white;" href="./add_product.php"> <button type="button" class="btn btn-inverse-primary btn-fw">Add Sp </button></a>
                    </div>
                </div>
