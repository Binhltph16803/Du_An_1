                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['btn_insert'])) {
                            if (isset($_POST['ten_loaihang'])) {
                                $add_loaihang = $product->add_loaihang($_POST['ten_loaihang'], $_FILES['image']['name']);
                        ...
                        ?>
                        <h4 style="margin: 25px 0 ;" class="card-title">Thông tin loại hàng thêm mới</h4>
                        <form method="post" enctype="multipart/form-data">
                            <div>
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" placeholder="Name" name="ten_loaihang" required>
                                </div>
                                <div class="form-group">
