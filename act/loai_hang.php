            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="margin:25px 0">Loại hàng</h4>
                                <table class="table">
                                    <tr>
                                        <th>Id loại hàng</th>
                                        <th>Tên loại hàng</th>
                                        <th>Image loại hàng</th>
                                        <th>Xử lý</th>
                                    </tr>
                                    <?php
                                    ...
                                    if (isset($_GET['id_del'])) {
                                        $del_loaihang = $product->del_loaihang($_GET['id_del']);
                                    }
                                    ...
                                    ?>
                                            <tr>
                                                <td width="200px"><?php echo $row['id_loaihang']; ?></td>
                                                <td width="300px"><?php echo $row['ten_loaihang']; ?></td>
                                                <td width="300px">
                                                    <img class="img_data" src="upload/<?php echo $row['img_loaihang']; ?>">
                                                </td>
                                                <td>
                                                    <a style="text-decoration: none; color: white;" href="./edit_loaihang.php?id_edit=<?php echo $row['id_loaihang']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw">Sửa</button></a>
                                                    <a style="text-decoration: none; color: white;" onclick="return confirm('Bạn có muốn xóa loại hàng này không ?')" href="?id_del=<?php echo $row['id_loaihang']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw">Xóa</button></a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
                    ...
                    <div class="template-demo" style="margin-left: 20px;">
                        <a style="text-decoration: none; color: white;" href="./add_loaihang.php"> <button type="button" class="btn btn-inverse-primary btn-fw">Add loại hàng</button></a>
                    </div>
                </div>
            </div>
