                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if (isset($_POST['btn_insert'])) {
                            ...
                            foreach ($_POST['gioi_tinh'] as $gioi_tinh) {
                                echo $gioi_tinh . " - ";
                            }
                            if (isset($_POST['ten_khachhang']) && isset($_POST['email_khachhang']) && isset($_POST['pass']) && isset($_POST['sdt_khachhang']) && isset($_POST['dia_chi'])) {
                                $add_user = $user->add_user($_POST['ten_khachhang'], $_FILES['image']['name'], $_POST['sdt_khachhang'], $_POST['email_khachhang'], $_POST['pass'], $_POST['dia_chi'], $gioi_tinh, $vai_tro);
                        ...
                        ?>
                        <h4 style="margin: 25px 0 ;" class="card-title">Thông tin use update</h4>
                        <form method="post" enctype="multipart/form-data">
                            <?php
                            $show_user_by_id = $user->show_user_by_id($_GET['id_edit']);
                            if (isset($show_user_by_id)) {
                                while ($row = $show_user_by_id->fetch_assoc()) {
                            ?>
                                    <div>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" class="form-control" placeholder="Name" name="ten_khachhang" value="<?php echo $row['ten_khachhang']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Email address</label>
                                            <input type="email" class="form-control" placeholder="Email" name="email_khachhang" value="<?php echo $row['email']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label> Password </label>
                                            <input type="text" class="form-control" placeholder="Password" name="pass" value="<?php echo $row['password']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Phone Number</label>
                                            <input type="text" class="form-control" placeholder="Phone number" name="sdt_khachhang" value="<?php echo $row['sdt_khachhang']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Giới tính</label>
                                            <select class="form-control" id="exampleSelectGender" name="gioi_tinh[]">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-xs-12">
                                                ...
                                                <img src="upload/<?php echo $row['img_khachhang']; ?>" alt="" width="100px">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Địa chỉ</label>
                                            <input type="text" class="form-control" placeholder="Địa chỉ" name="dia_chi" value="<?php echo $row['dia_chi']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Vai trò</label>
                        ...
                        <a style="text-decoration: none; color: white;" href="../admin/pages/tables/User.php"><button class="btn btn-gradient-primary mr-2" style=" margin-top:20px ;"> Danh sách </button></a>
                    </div>
                </div>
            </div>
