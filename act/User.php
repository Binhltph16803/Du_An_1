            ...
            <div class="main-panel">
                <div class="content-wrapper">
                        ...
                        <div class="card">
                            ...
                            <table class="table table-striped">
                                ...
                                if (isset($_GET['id_del'])) {
                                    $del_user = $user->del_user($_GET['id_del']);
                                }
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><img src="upload/<?php echo $row['img_khachhang']; ?>" alt=""></td>
                                            ...
                                            <td>
                                                <a style="text-decoration: none; color: white;" href="./edit_user.php?id_edit=<?php echo $row['id_khachhang']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw" style="margin-bottom:20px;">Sửa</button></a>
                                                <br>
                                                <a style="text-decoration: none; color: white;" onclick="return confirm('Bạn có muốn xóa user này không ?')" href="?id_del=<?php echo $row['id_khachhang']; ?>"> <button type="button" class="btn btn-inverse-primary btn-fw">Xóa</button></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
                    ...
                    <div class="template-demo">
                        <a style="text-decoration: none; color: white;" href="./add_user.php"> <button type="button" class="btn btn-inverse-primary btn-fw">Add user </button></a>
                    </div>
                </div>
