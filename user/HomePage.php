    ...
    <div class="container">
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <?php
                $list_slide = $product->show_slide();
                if (isset($list_slide)) {
                    while ($row = $list_slide->fetch_assoc()) {
                ?>
        ...
        <main>
            <div class="row row-cols-1 row-cols-md-5 g-4">
                ...
                <?php
                $product = new products_class();
                $show_product = $product->show_products_home();
            ...
            <div class="" style="background-color:olivedrab;padding: 5px 0;border-radius: 10px; margin-bottom: 20px;">
                <h3 style="margin-left: 20px;">Hàng hóa đặc biệt</h3>
            </div>
            <div class="row row-cols-1 row-cols-md-5 g-4">
                <!--  -->
                <?php
                $product = new products_class();
                $show_product_db = $product->show_products_dac_biet();
                if (isset($show_product_db)) {
                    while ($row = $show_product_db->fetch_assoc()) {
                ?>
                        <div class="col">
                            <div class="card h-100">
                                <a href="./chitiet.php?idchitiet=<?php echo $row['id_hanghoa']; ?>"><img src="../admin/upload/<?php echo $row['img_hanghoa']; ?>" class="card-img-top" alt="..."></a>
            ...
            <hr>
            <div class="" style="background-color:olivedrab;padding: 5px 0;border-radius: 10px; margin-bottom: 20px;">
                <h3 style="margin-left: 20px;">Hàng hóa giảm giá</h3>
            </div>
            <div class="row row-cols-1 row-cols-md-5 g-4">
                <!--  -->
                <?php
                $product = new products_class();
                $show_product_gg = $product->show_products_giam_gia();
                if (isset($show_product_gg)) {
                    while ($row = $show_product_gg->fetch_assoc()) {
                ?>
                        <div class="col">
                            <div class="card h-100">
                                <a href="./chitiet.php?idchitiet=<?php echo $row['id_hanghoa']; ?>"><img src="../admin/upload/<?php echo $row['img_hanghoa']; ?>" class="card-img-top" alt="..."></a>
