...
<body>
    ...
    if (isset($_POST['btn_insert'])) {
        ...
        if (isset($_POST['ten_hh']) && isset($_POST['don_gia']) && isset($_POST['dac_biet']) && isset($_POST['giam_gia']) && isset($_POST['mo_ta'])) {
            $insert_product = $product->update_product($_POST['ten_hh'], $_POST['don_gia'], $_POST['giam_gia'], $_FILES['image']['name'], $_POST['mo_ta'], $_POST['dac_biet'], $ma_loai, $date, $id);
    ...
    <div class="container">
        ...
        <article>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <button class="btn"><a href="./Productlist.php">Danh sách</a></button>
            </form>
        </article>
    </div>
</body>
